...
public class OptionsUI : MonoBehaviour
{
    ...
    private void Start() {
        KitchenGameManager.Instance.OnGameUnpaused += KitchenGameMangager_OnGameUnpaused;
    ...
    private void KitchenGameMangager_OnGameUnpaused(object sender, System.EventArgs e) {
        Hide();
    }
    ...
    private void RebindBinding(GameInput.Binding binding) {
        ...
        GameInput.Instance.Rebindbing(binding, () => {
            HidePressToRebindKey();
            UpdateVisual();
        });
    }
